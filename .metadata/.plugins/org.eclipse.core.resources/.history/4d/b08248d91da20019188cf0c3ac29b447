...
public class Main {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < name.length; i++){
	        if(name[i] == 1) array[1]++;
			   else if(name[i] == 2) array[2]++;
			   else if(name[i] == 3) array[3]++;
			   else if(name[i] == 4) array[4]++;
			   else if(name[i] == 5) array[5]++;
		}
		System.out.println("The number 1 was found in the array " + array[1] + " times");
		System.out.println("The number 2 was found in the array " + array[2] + " times");
		System.out.println("The number 3 was found in the array " + array[3] + " times");
		System.out.println("The number 4 was found in the array " + array[4] + " times");
		System.out.println("The number 5 was found in the array " + array[5] + " times");
		//5. Task five
